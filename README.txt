...
=== Mono Build (tested on Debian 8/sid) ===
Soap and SQLite extensions are not currently built
```
cd Solutions
xbuild /property:Configuration=Release /property:TreatWarningsAsErrors=false
```
