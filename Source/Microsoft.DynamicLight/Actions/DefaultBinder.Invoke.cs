...
namespace Microsoft.Scripting.Actions {
    ...
    public partial class DefaultBinder : ActionBinder {
        ...
        protected DynamicMetaObject MakeMetaMethodCall(CallSignature signature, OverloadResolverFactory resolverFactory, TargetInfo targetInfo) {
        ...
        protected DynamicMetaObject MakeCannotCallRule(DynamicMetaObject self, Type type) {
            return MakeError(
