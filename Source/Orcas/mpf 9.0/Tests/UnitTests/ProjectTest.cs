	...
	public class PackageTest
	{
		...
		private class PackageTestEnvironment : IDisposable
		{
			...
			public PackageTestEnvironment()
			{
				...
				Microsoft.Build.BuildEngine.Engine engine = initEngine.Invoke(null, new object[2] { null, services }) as Microsoft.Build.BuildEngine.Engine;
				...
				Microsoft.Build.BuildEngine.Project buildProject = initProject.Invoke(null, new object[2] { engine, fullpath }) as Microsoft.Build.BuildEngine.Project;
