...
namespace PHP.VisualStudio.PhalangerProject.WPFProviders
{
    ...
    public class PythonEventBindingProvider : EventBindingProvider
    {
        ...
        private PhalangerFileNode pyFile;

        internal PythonEventBindingProvider(PhalangerFileNode pyFile)
        {
            this.pyFile = pyFile;
        ...
        public CodeDomDocDataAdapter GetDocDataAdapterForPyFile()
        {
            ...
            DocData data = new DocData((project as PhalangerProjectNode).ProjectMgr.Site, pyFile.Url);
            CodeDomDocDataAdapter cdDocDataAdapter = new CodeDomDocDataAdapter((project as PhalangerProjectNode).ProjectMgr.Site, data);
