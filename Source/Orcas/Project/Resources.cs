...
namespace PHP.VisualStudio
{
	...
	internal sealed class SR
	{
		...
		internal const string CompilationMode = "CompilationMode";
		internal const string CompilationModeDescription = "CompilationModeDescription";
		internal const string LanguageFeatures = "LanguageFeatures";
		internal const string LanguageFeaturesDescription = "LanguageFeaturesDescription";
		internal const string DisabledWarnings = "DisabledWarnings";
		internal const string DisabledWarningsDescription = "DisabledWarningsDescription";
		...
		internal SR()
		{
            resources = new System.Resources.ResourceManager("PHP.VisualStudio.PhalangerProject.Resources", this.GetType().Assembly);
		}
...
#if DEBUG
                System.Diagnostics.Debug.Print("Attempt to get inexistent resource {0}.", name);
