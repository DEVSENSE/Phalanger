...
namespace PHP.VisualStudio.PhalangerLanguageService {
    ...
    internal class _HierarchyListener : IVsHierarchyEvents, IDisposable {

        private IVsHierarchy hierarchy;
        private uint cookie;

        public _HierarchyListener(IVsHierarchy hierarchy) {
            if (null == hierarchy) {
        ...
        private bool IsPythonFile(uint itemId, out string canonicalName) {
            ...
            return (0 == string.Compare(extension, PhalangerConstants.phpFileExtension, StringComparison.OrdinalIgnoreCase));
        }
