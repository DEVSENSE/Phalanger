...
namespace PHP.VisualStudio.PhalangerLanguageService {
    ...
    public class _Library : IVsSimpleLibrary2 {
        private Guid guid;
        private _LIB_FLAGS2 capabilities;
        private _LibraryNode root;

        public _Library(Guid libraryGuid) {
            this.guid = libraryGuid;
            root = new _LibraryNode("", _LibraryNode.LibraryNodeType.Package);
        }
