...
namespace PHP.VisualStudio.PhalangerLanguageService {
    ...
    /// </summary>
    internal class PythonLibraryNode : _LibraryNode {
        ...
        protected override _LibraryNode Clone() {
        ...
        private IntPtr FindDocDataFromRDT() {
            ...
            IVsRunningDocumentTable rdt = PhalangerPackage.GetGlobalService(typeof(SVsRunningDocumentTable)) as IVsRunningDocumentTable;
            if (null == rdt) {
                return IntPtr.Zero;
            }
