...
namespace PHP.Library.Memcached
{
	...
	/// </summary>
	[Serializable]
	public sealed class MemcachedLocalConfig : IPhpConfiguration, IPhpConfigurationSection
	{
        internal MemcachedLocalConfig() { }
		...
		{
            return (MemcachedLocalConfig)this.MemberwiseClone();
		}
	...
	/// </summary>
	[Serializable]
	public sealed class MemcachedGlobalConfig : IPhpConfiguration, IPhpConfigurationSection
	{
        internal MemcachedGlobalConfig() { }
		...
		public IPhpConfiguration DeepCopy()
		{
            return (MemcachedGlobalConfig)this.MemberwiseClone();
		}
	}
	...
	public static class MemcachedConfiguration
	{
		...
		{
			MemcachedLocalConfig local = (MemcachedLocalConfig)config.GetLibraryConfig(MemcachedLibraryDescriptor.Singleton);
			MemcachedLocalConfig @default = DefaultLocal;
			MemcachedGlobalConfig global = Global;
		...
		public static void LegacyOptionsToXml(XmlTextWriter writer, Hashtable options, bool writePhpNames) // GENERICS:<string,string>
		{
			...
			MemcachedLocalConfig local = new MemcachedLocalConfig();
			MemcachedGlobalConfig global = new MemcachedGlobalConfig();
		...
		{
			//const string s = MemcachedLibraryDescriptor.ExtensionName;
		...
		/// </summary>
		public static MemcachedLocalConfig Local
		{
			get
			{
                return (MemcachedLocalConfig)Configuration.Local.GetLibraryConfig(MemcachedLibraryDescriptor.Singleton);
			}
		}
		...
		/// </summary>
		public static MemcachedLocalConfig DefaultLocal
		{
			get
			{
                return (MemcachedLocalConfig)Configuration.DefaultLocal.GetLibraryConfig(MemcachedLibraryDescriptor.Singleton);
			}
		}
		...
		/// </summary>
		public static MemcachedGlobalConfig Global
		{
			get
			{
                return (MemcachedGlobalConfig)Configuration.Global.GetLibraryConfig(MemcachedLibraryDescriptor.Singleton);
			}
		}
		...
		public static MemcachedLocalConfig GetLocal(ScriptContext/*!*/ context)
		{
			if (context == null)
				throw new ArgumentNullException("context");

			return (MemcachedLocalConfig)context.Config.GetLibraryConfig(MemcachedLibraryDescriptor.Singleton);
		}
