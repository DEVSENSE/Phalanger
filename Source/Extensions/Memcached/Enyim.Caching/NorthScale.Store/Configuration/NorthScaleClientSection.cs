...
namespace NorthScale.Store.Configuration
{
	...
	public sealed class NorthScaleClientSection : ConfigurationSection, INorthScaleClientConfiguration
	{
		...
		/// </summary>
		[ConfigurationProperty("nodeLocator", IsRequired = false), TypeConverter(typeof(TypeNameConverter)), InterfaceValidator(typeof(Enyim.Caching.Memcached.Distribution.IMemcachedNodeLocator))]
		...
		/// </summary>
		[ConfigurationProperty("transcoder", IsRequired = false), TypeConverter(typeof(TypeNameConverter)), InterfaceValidator(typeof(Enyim.Caching.Memcached.TranscoderBase))]
