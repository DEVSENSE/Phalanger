...
namespace Enyim.Caching.Memcached
{
	...
	public sealed class ServerStats
	{
		...
		/// </summary>
        public static readonly NamedIPEndPoint All = new NamedIPEndPoint(null, 0, 0, IPAddress.Any);
        ...
        internal Dictionary<NamedIPEndPoint, Dictionary<string, string>> results;

        internal ServerStats(Dictionary<NamedIPEndPoint, Dictionary<string, string>> results)
        {
        ...
        public long GetValue(NamedIPEndPoint server, StatItem item)
		{
			...
			// sum & return
            foreach (NamedIPEndPoint ep in this.results.Keys)
			{
        ...
        public Version GetVersion(NamedIPEndPoint server)
		{
        ...
        public TimeSpan GetUptime(NamedIPEndPoint server)
		{
        ...
        public string GetRaw(NamedIPEndPoint server, string key)
		{
		...
		/// <returns>The value of the stat item</returns>
        public string GetRaw(NamedIPEndPoint server, StatItem item)
		{
