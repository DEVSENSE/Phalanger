...
namespace Enyim.Caching.Memcached.Operations.Binary
{
	internal class MutatorOperation : ItemOperation
	{
        ...
        public MutatorOperation(IServerPool pool, MutationMode mode, string key, string serverKey, ulong defaultValue, ulong delta, uint expires)
		...
		protected override ResConstants ExecuteAction()
		{
			...
			if (retval == ResConstants.Success)
			{
