        ...
        internal bool ValidateAttribute(int attribute, object value)
        {
            if (Enum.IsDefined(typeof(PDOAttributeType), attribute))
            {
                ...
                switch (att)
                {
                    ...
                    case PDOAttributeType.PDO_ATTR_CASE: return Enum.IsDefined(typeof(PDOStatics.pdo_case_conversion), value);
                    ...
                    case PDOAttributeType.PDO_ATTR_ERRMODE: return Enum.IsDefined(typeof(PDOStatics.pdo_error_mode), value);
                    ...
                    case PDOAttributeType.PDO_ATTR_ORACLE_NULLS: return Enum.IsDefined(typeof(PDOStatics.pdo_null_handling), value);
