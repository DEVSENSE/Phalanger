	...
	public static class MultiByteString
	{
        ...
        public static Dictionary<string, Encoding> Encodings
        {
            get
            {
                if (_encodings == null)
                {
                    Dictionary<string, Encoding> enc = new Dictionary<string, Encoding>();
        ...
        public static string GetPreferredMimeName(string encoding_name)
        {
            ...
            {
                PhpException.ArgumentValueNotSupported("encoding_name");
                return null;
            }
        ...
        {
            return ObjectToString(str, encodingGetter).Length;            
        }
