...
namespace PHP.Core.CodeDom {
    ...
    public static class Helper {
        ...
        [Obsolete("Do not use this member! This is only CodeDOM replacement for PHP unset pseudo-function")][EditorBrowsable(EditorBrowsableState.Never)]
        ...
        [Obsolete("Do not use this class! This is only CodeDOM replacement for PHP indirect access to static field (MyClass::$$var)")][EditorBrowsable(EditorBrowsableState.Never)]
