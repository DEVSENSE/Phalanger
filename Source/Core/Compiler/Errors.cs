...
namespace PHP.Core
{
	...
	public struct ErrorSeverity
	{
		...
		public PhpError ToPhpCompileError()
		{
			return (value == Values.Warning) ? PhpError.CompileWarning : PhpError.CompileError;
		}
	...
	public abstract class ErrorSink : MarshalByRefObject
	{
		...
		public void AddInternalError(Exception/*!*/ e)
		{
			...
			const string BugTrackerUrl = "http://www.codeplex.com/WorkItem/List.aspx?ProjectName=Phalanger";
