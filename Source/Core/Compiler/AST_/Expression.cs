...
namespace PHP.Core.Compiler.AST
{
    partial class NodeCompilers
    {
        ...
        abstract class ExpressionCompiler<T> : IExpressionCompiler where T : Expression
        {
            ...
            public virtual Evaluation EvaluatePriorAnalysis(T node, Reflection.SourceUnit sourceUnit)
            {
            ...
            Evaluation IExpressionCompiler.EvaluatePriorAnalysis(Expression node, SourceUnit sourceUnit)
            {
