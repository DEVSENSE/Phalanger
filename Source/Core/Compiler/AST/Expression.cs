...
{
    #region unfinished declaration use
    ...
    /// Define VisitMe only.
    /// </summary>
    public abstract class NotCompletedVarLikeConstructUse : VarLikeConstructUse
    {
        #region not implemented abstract methods (not needed, never used)
        internal override Operations Operation
        {
            get { throw new NotImplementedException(); }
        }
        internal override PHP.Core.Evaluation Analyze(PHP.Core.Analyzer analyzer, ExInfoFromParent info)
        {
            throw new NotImplementedException();
        }
        internal override PHP.Core.PhpTypeCode Emit(PHP.Core.CodeGenerator codeGenerator)
        {
            throw new NotImplementedException();
        }
        #endregion
        ...
        /// <summary>
        /// Is member of (after ->, :: or :::)
        /// </summary>
        public Expression isMemberOf = null;

        /// <summary>
        /// Is member of this type.
        /// </summary>
        public readonly MemberType isMemberOfType;

        /// <summary>
        /// the part of the element name
        /// </summary>
        public readonly string notCompletedName;
        ...
        public NotCompletedVarLikeConstructUse(Position position, string notCompletedName, MemberType isMemberOfType)
            : base(position)
        {
            this.notCompletedName = notCompletedName;
            this.isMemberOfType = isMemberOfType;
        }
