...
namespace PHP
{
	namespace ExtManager
	{
		...
		private:
			...
			void EmitParameterHandlingPrologue(ILEmitter ^il, MethodBuilder ^methodBuilder,
			...
			void EmitParameterHandlingEpilogue(ILEmitter ^il, MethodBuilder ^methodBuilder,
					FunctionTypeInfo ^typeInfo, int extraParamCount);
			...
			void EmitRefInfoArray(ILEmitter ^il, String ^functionName, TypeBuilder ^typeBuilder,
				array<int> ^refInfo);
			...
			void GenerateFunction(String ^className, String ^functionName, TypeBuilder ^typeBuilder,
					FunctionTypeInfo ^typeInfo, bool argfullOverload);
			...
			void GenerateFunctionOverloadsPhase2(String ^className, String ^functionName,
					TypeBuilder ^typeBuilder, FunctionTypeInfo ^typeInfo);
			...
			MethodInfo ^GenerateDynamicFunction(String ^className, String ^methodName,
					TypeBuilder ^typeBuilder, FunctionTypeInfo ^typeInfo);
		...
		internal:
			static Version ^wrapperVersion = gcnew Version(2, 0, 0, 0);
