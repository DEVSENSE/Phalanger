...
//
// config.w32.h
// - this is slightly modified config.w32.h, originally PHP 5.3.3 source files
//
...
#define CONFIGURE_COMMAND "cscript /nologo configure.js  \"--enable-isapi\" \"--enable-fileinfo\""
