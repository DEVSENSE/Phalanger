...
//
// zend_opcode.cpp
// - this is slightly modified zend_opcode.c, originally PHP 5.3.3 source files
//
...
{
	op_array->opcodes = (zend_op*)erealloc(op_array->opcodes, (op_array->size)*sizeof(zend_op));
}
...
zend_brk_cont_element *get_next_brk_cont_element(zend_op_array *op_array)
{
	...
	op_array->brk_cont_array = (zend_brk_cont_element*)erealloc(op_array->brk_cont_array, sizeof(zend_brk_cont_element)*op_array->last_brk_cont);
