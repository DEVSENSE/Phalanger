...
//
// zend.cpp
// - this is slightly modified zend.c, originally PHP 5.3.3 source files
//
...
//{
//#ifdef ZTS
//	zend_compiler_globals *compiler_globals = (zend_compiler_globals *)ts_resource(compiler_globals_id);
//	zend_executor_globals *executor_globals = (zend_executor_globals *)ts_resource(executor_globals_id);
//
...
{
	TMP_UNSUPPORTED_MSG("zend_error");
