...
//
// zend_llist.cpp
// - this is slightly modified zend_llist.c, originally PHP 5.3.3 source files
//
...
{
	zend_llist_element *tmp = (zend_llist_element*)pemalloc(sizeof(zend_llist_element)+l->size-1, l->persistent);
