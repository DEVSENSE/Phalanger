...
{
	return (zend_mm_storage *)malloc(sizeof(zend_mm_storage));
}
...
/* See http://support.microsoft.com/kb/190351 */
	...
	heap = (zend_mm_heap *)malloc(sizeof(struct _zend_mm_heap));
...
# endif
	...
	if (internal) {
		...
		zend_mm_heap *mm_heap = (zend_mm_heap *)_zend_mm_alloc_int(heap, sizeof(zend_mm_heap)  ZEND_FILE_LINE_CC ZEND_FILE_LINE_EMPTY_CC);
