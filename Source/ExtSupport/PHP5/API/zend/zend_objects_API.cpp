...
//
// zend_objects_API.cpp
// - this is slightly modified zend_objects_API.c, originally PHP 5.3.3 source files
//
...
{
	*object_clone = (zend_proxy_object*)emalloc(sizeof(zend_proxy_object));
...
{
	zend_proxy_object *probj = (zend_proxy_object*)zend_object_store_get_object(*property TSRMLS_CC);
...
{
	zend_proxy_object *pobj = (zend_proxy_object*)emalloc(sizeof(zend_proxy_object));
	zval *retval;
