...
#pragma region ORIGINAL_COMMENTED_CODE
...
{
	TMP_UNSUPPORTED_MSG("get_active_class_name");
...
{
	TMP_UNSUPPORTED_MSG("get_active_function_name");
...
{
	TMP_UNSUPPORTED_MSG("zend_get_executed_filename");
...
{
	TMP_UNSUPPORTED_MSG("zend_get_executed_lineno");
...
{
	TMP_UNSUPPORTED_MSG("zend_is_executing");
...
{
	TMP_UNSUPPORTED_MSG("_zval_ptr_dtor");
...
{
	TMP_UNSUPPORTED_MSG("_zval_internal_ptr_dtor");
...
{
	TMP_UNSUPPORTED_MSG("zend_is_true");
...
{
	TMP_UNSUPPORTED_MSG("zval_update_constant_ex");
...
{
	TMP_UNSUPPORTED_MSG("zval_update_constant_inline_change");
...
{
	TMP_UNSUPPORTED_MSG("zval_update_constant_no_inline_change");
...
{
	TMP_UNSUPPORTED_MSG("zval_update_constant");
...
{
	TMP_UNSUPPORTED_MSG("zend_call_function");
	return 0;
...
{
	TMP_UNSUPPORTED_MSG("zend_lookup_class_ex");
	return 0;
...
{
	TMP_UNSUPPORTED_MSG("zend_lookup_class");
	return 0;
...
{
	TMP_UNSUPPORTED_MSG("zend_eval_stringl");
	return 0;
...
{
	TMP_UNSUPPORTED_MSG("zend_eval_string");
	return 0;
...
{
	TMP_UNSUPPORTED_MSG("zend_eval_stringl_ex");
	return 0;
...
{
	TMP_UNSUPPORTED_MSG("zend_eval_string_ex");
	return 0;
...
{
	TMP_UNSUPPORTED_MSG("zend_timeout");
...
#pragma region Original commented code
...
{
	TMP_UNSUPPORTED_MSG("zend_set_timeout");
...
{
	TMP_UNSUPPORTED_MSG("zend_reset_all_cv");
...
{
	TMP_UNSUPPORTED_MSG("zend_delete_global_variable");
	return 0;
...
{
	TMP_UNSUPPORTED_MSG("zend_rebuild_symbol_table");
