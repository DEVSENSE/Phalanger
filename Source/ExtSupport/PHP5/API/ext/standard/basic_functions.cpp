...
//
// basic_functions.cpp
// - this is slightly modified basic_functions.c, originally PHP 5.3.3 source files
//
...
//#include "php_standard.h"//todo:see what's necessary I don't want to add it all
#include "php_math.h"
#include "php_http.h"
