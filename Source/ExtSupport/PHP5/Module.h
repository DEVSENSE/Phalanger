...
namespace PHP
{
	namespace ExtManager
	{
		...
		public:
			...
			Function(Module ^mod, const zend_function_entry *func)
			{
				functionEntry = func;
				containingModule = mod;
			}
			...
			virtual Object ^Invoke(bool retValueUsed, PHP::Core::PhpObject ^self, array<Object ^> ^args,
				array<int> ^refInfo);
		...
		protected:
			...
			/// </summary>
			const zend_function_entry *functionEntry;
		...
		public:
			...
			/// <param name="func">Unmanaged pointer to the corresponding <c>zend_function_entry</c> block.</param>
			Method(Class ^cls, const zend_function_entry *func);
		...
		public:
			...
			/// <returns>The return value (only valid if <paramref name="retValueUsed"/> is <B>true</B>.</returns>
			Object ^InvokeHandler(bool retValueUsed, PHP::Core::PhpObject ^self, array<Object ^> ^args,
...
#pragma warning (pop)
		...
		public:
			...
			bool IsStdClass()
			{
				return originalClassEntry == zend_standard_class_def;
			}
		...
		public:
			...
			static Class ^StdClass = gcnew Class(nullptr, zend_standard_class_def, NULL);
		};
