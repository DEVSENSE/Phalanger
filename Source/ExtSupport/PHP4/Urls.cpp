...
//
// Urls.cpp 
// - slightly modified url.c, originally PHP source file
//
...
/*
   ...
   +----------------------------------------------------------------------+
 */
/* $Id: Urls.cpp,v 1.1.2.2 2006/04/15 20:19:12 prosl0am Exp $ */
...
/* {{{ php_url_decode
 */
ZEND_API int php_url_decode(char *str, int len)
{
	char *dest = str;
	char *data = str;
...
/* {{{ php_raw_url_decode
 */
ZEND_API int php_raw_url_decode(char *str, int len)
{
	char *dest = str;
	char *data = str;
