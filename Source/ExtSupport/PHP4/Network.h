...
//
// Network.h
// - slightly modified php_network.h, originally PHP source file
//
...
/*
   ...
   +----------------------------------------------------------------------+
 */
/* $Id: Network.h,v 1.1.2.2 2006/04/15 20:19:12 prosl0am Exp $ */
...
ZEND_API int php_connect_nonb(int sockfd, const struct sockaddr *addr, socklen_t addrlen, struct timeval *timeout);

#ifdef PHP_WIN32
ZEND_API int php_connect_nonb_win32(SOCKET sockfd, const struct sockaddr *addr, socklen_t addrlen, struct timeval *timeout);
#endif
