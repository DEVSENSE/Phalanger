...
//
// Streams.h
// - slightly modified php_streams.h, originally PHP source file
//
...
/* $Id: Streams.h,v 1.1.2.2 2006/04/15 20:19:12 prosl0am Exp $ */
...
ZEND_API php_stream *_php_stream_alloc(php_stream_ops *ops, void *abstract,
...
ZEND_API size_t _php_stream_read(php_stream *stream, char *buf, size_t count TSRMLS_DC);
...
ZEND_API char *_php_stream_get_line(php_stream *stream, char *buf, size_t maxlen, size_t *returned_len TSRMLS_DC);
...
ZEND_API php_stream *_php_stream_opendir(char *path, int options, php_stream_context *context STREAMS_DC TSRMLS_DC);
...
ZEND_API size_t _php_stream_copy_to_mem(php_stream *src, char **buf, size_t maxlen,
...
ZEND_API size_t _php_stream_passthru(php_stream * src STREAMS_DC TSRMLS_DC);
...
ZEND_API extern php_stream_ops php_stream_stdio_ops;
 ...
 * ZEND_API int php_stream_is(php_stream *stream, php_stream_ops *ops); */
...
ZEND_API php_stream *_php_stream_open_wrapper_ex(char *path, char *mode, int options, char **opened_path, php_stream_context *context STREAMS_DC TSRMLS_DC);
...
ZEND_API zend_bool _php_stream_open_wrapper_as_file_handle(char * path, char * mode, int options, zend_file_handle * STREAMS_DC TSRMLS_DC);
...
ZEND_API extern php_stream_ops php_stream_userspace_ops;
ZEND_API extern php_stream_ops php_stream_userspace_dir_ops;
