...
//
// ThreadSafeHash.cpp 
// - contains definitions of TS hash tables (= PHP arrays) related functions
...
/* $Id: ThreadSafeHash.cpp,v 1.1.2.2 2006/04/15 20:19:12 prosl0am Exp $ */
...
void begin_read(TsHashTable *ht)
{
#ifdef ZTS
