...
//
// Snprintf.h
// - slightly modified snprintf.h, originally PHP source file
//
...
BEGIN_EXTERN_C()
ZEND_API int ap_php_snprintf(char *, size_t, const char *, ...);
ZEND_API int ap_php_vsnprintf(char *, size_t, const char *, va_list ap);
